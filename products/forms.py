...
class ProductForm(forms.ModelForm):
    ...
    description = forms.CharField(label='Product Description', max_length=300, required=True)
    price = forms.DecimalField(label='Product Price', max_digits=10, decimal_places=2, required=True)
